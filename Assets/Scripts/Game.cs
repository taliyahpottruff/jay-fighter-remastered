...
public class Game
{
    ...
    public static Dictionary<string, Map> MAPS = new Dictionary<string, Map>() {
        ...
        {"Yard", new Map("Yard", 25, 40, new MapObj[] {
            ...
            //Colliders
            new MapObj("Collider", 4f, 3f, 1, 3, true, true),
            new MapObj("Collider", 4f, -3f, 1, 3, true, true),
            new MapObj("Collider", 6f, 2f, 5, 1, true, true),
            new MapObj("Collider", 6f, -2f, 5, 1, true, true),
            new MapObj("Collider", -4f, 3f, 1, 3, true, true),
            new MapObj("Collider", -4f, -3f, 1, 3, true, true),
            new MapObj("Collider", -6.5f, 2f, 4, 1, true, true),
            new MapObj("Collider", -6.5f, -2f, 4, 1, true, true),
            new MapObj("Collider", -2.5f, -4f, 2, 1, true, true),
            new MapObj("Collider", 2.5f, -4f, 2, 1, true, true),
            new MapObj("Collider", -2f, -5.5f, 1, 2, true, true),
            new MapObj("Collider", 2f, -5.5f, 1, 2, true, true),
            new MapObj("Collider", 0f, -10f, 9, 1, true, true),
            new MapObj("Collider", -4, -11.5f, 1, 2, true, true),
            new MapObj("Collider", 4, -11.5f, 1, 2, true, true),
            new MapObj("Collider", 0, -12, 7, 1, true, true),
            new MapObj("Collider", -12, 0, 1, 21, true, true),
            new MapObj("Collider", -6.5f, 10, 10, 1, true, true),
            new MapObj("Collider", -2, 11, 1, 3, true, true),
            new MapObj("Collider", -3, 12.5f, 1, 2, true, true),
            new MapObj("Collider", -4, 15, 1, 6, true, true),
            new MapObj("Collider", -3, 18.5f, 1, 2, true, true),
            new MapObj("Collider", 0, 19, 7, 1, true, true),
            new MapObj("Collider", 3.5f, 18, 2, 1, true, true),
            new MapObj("Collider", 4, 15, 1, 6, true, true),
            new MapObj("Collider", 3, 12.5f, 1, 2, true, true),
            new MapObj("Collider", 2, 11, 1, 3, true, true),
            new MapObj("Collider", 7.5f, 10, 10, 1, true, true),
            new MapObj("Collider", 12, 0, 1, 20, true, true),
            new MapObj("Collider", 10, -10, 5, 1, true, true),
            new MapObj("Collider", 8, -15.5f, 1, 10, true, true),
            new MapObj("Collider", 0, -20, 16, 1, true, true),
            new MapObj("Collider", -8, -15, 1, 11, true, true),
            new MapObj("Collider", -10, -10, 4, 1, true, true),
            new MapObj("Collider", 0, 6, 17, 1, true, true),
            new MapObj("Collider", -8, 4, 1, 3, true, true),
            new MapObj("Collider", 8, 4, 1, 3, true, true),
            new MapObj("Collider", -8, -4.5f, 1, 4, true, true),
            new MapObj("Collider", -5, -6, 5, 1, true, true),
            new MapObj("Collider", 5.5f, -6, 6, 1, true, true),
            new MapObj("Collider", 8, -4, 1, 3, true, true),
            new MapObj("Collider", 0, 4f, 8, 1, true, true),
            //Spawns
